...
const Likes = () => {
  ...
  return (
    <div className="relative overflow-x-auto shadow-md rounded-lg px-4 bg-gray-600/20">
      <table className="w-full text-sm text-left rtl:text-right  overflow-hidden">
        ...
        <tbody>
        {likes.map((user,idx)=>{
          <tr className="bg-glass" key={user.username}>
