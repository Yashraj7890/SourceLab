		...
		<div className='lg:w-1/3 w-full flex flex-col gap-2 md:sticky md:top-10'>
			<div className='bg-gray-600/20  rounded-lg p-4'>
				<div className='flex gap-4 items-center'>
					...
					<LikeProfile userProfile={userProfile}></LikeProfile>
						<a
				...
				<div className='my-2'>
					<p className='text-blue-200 font-bold text-sm'>Member since</p>
				...
				{userProfile?.email && (
					<div className='my-2'>
						<p className='text-blue-200 font-bold text-sm'>Email address</p>
				...
				{userProfile?.name && (
					<div className='my-2'>
						<p className='text-blue-200 font-bold text-sm'>Full name</p>
				...
				<div className='my-2'>
					<p className='text-blue-200 font-bold text-sm'>Username</p>
			...
			<div className='flex flex-wrap gap-2 mx-4'>
				...
				<div className='flex bg-gray-600/20 border border-blue-400 items-center gap-2  rounded-lg p-2 flex-1 min-w-24'>
